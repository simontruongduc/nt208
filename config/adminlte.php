...
return [
    ...
    */
    ...
    'forgot_url'  => 'cms/auth/forgot',

    'verifyToken' => 'cms/auth/verifyToken',

    'reset_url'   => 'cms/auth/reset',
    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Backup data',
                    'url'  => 'cms/control/export',
                    'icon' => 'gamepad',
                ],
                [
                    'text' => 'Import data',
                    'url'  => 'cms/control/import',
                    'icon' => 'gamepad',
                ],
                [
                    'text' => 'Control',
